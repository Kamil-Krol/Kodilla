...
public class CrudAppTestSuite{
    private static final String BASE_URL = "https://kamil-krol.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("kamil.krold@gmail.com");		        // [3]
        driverTrello.findElement(By.id("password")).sendKeys("3hyTE2ty");		    // [4]
        WebElement el = driverTrello.findElement(By.id("login"));
        el.submit();									                                // [5]

        Thread.sleep(10000);								                            // [6]

        driverTrello.findElement(By.id("password")).sendKeys("3hyTE2ty");		    // [7]
